    ...
    <div class="admin-container">
        ...
        <div class="ticket-table">
            <table>
                ...
                <tbody>
                    <?php
                        $sql = "SELECT users.username, users.plan, tickets.ticketID, tickets.subject, tickets.description, tickets.status, tickets.created_at FROM tickets JOIN users ON tickets.userID = users.userID ORDER BY status ASC, created_at DESC;";
